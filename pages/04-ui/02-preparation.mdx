...
1. W klasie `Main` uzupełnij klucz do `Google Custom Search JSON API,` (użyj klucza z poprzedniego laboratorium - tutaj również będziemy pobierać obrazki przez Google Grafika).
