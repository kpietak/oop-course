...
1. Tworzymy Query korzystając z metody session.createQuery(). Jako argumenty podajemy treść zapytania oraz klasę, której dotyczy zapytanie. W zapytaniu możemy umieszczać paramtery, korzystając z dwukropka (:nazwa_parametru).
1. Pod parametry podkładamy konkretne dane.
