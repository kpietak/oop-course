...
W celu wygenerowania szablonu projektu można skorzystać ze strony [Spring Initializr](https://start.spring.io/) lub wykorzystać wbudowany generator IntelliJ IDEA (*Generators -> Spring Boot*). W obu przypadkach należy wybrać następujące parametry:
